    ...
    public function get_repeater_text_input( $item, $key, $data ) {
        ...
        <div class="etn-label-item <?php echo esc_attr($hide_block) ?> <?php echo esc_attr($class)?>">
            ...
            <div class="etn-meta">
                ...
                <input autocomplete="off" class="etn-form-control" type="<?php echo esc_attr( $item['type'] ); ?>" name="<?php echo esc_attr($key)?>"  value="<?php echo esc_attr($value); ?>" placeholder="<?php echo esc_attr( $placeholder ); ?>" />
            </div>
        </div>
        <?php
    }
