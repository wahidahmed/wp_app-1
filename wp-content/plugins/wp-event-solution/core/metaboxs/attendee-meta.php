    ...
    public function etn_attendee_meta_fields() {
        ...
        if( !empty( $order_id) ) {
            echo "<div class='etn-label-item etn_event_meta_field view-order-button'>
                    <div class='etn-label'>
                        <label>".esc_html__('Order Details', 'eventin')."</label>
                    </div>
                    <div class='etn-meta'>
                        <a href='".esc_attr(get_edit_post_link( $order_id, 'eventin') )."' target='_blank' class='preview button'>".esc_html__('View', 'eventin')."
                        </a>
                    </div>
                </div>";
