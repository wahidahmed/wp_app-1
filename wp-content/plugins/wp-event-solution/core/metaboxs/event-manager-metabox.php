                ...
                <div class='form-inline etn-meta social-repeater <?php echo esc_attr( $class ); ?>'><div data-repeater-list='<?php echo esc_attr( $social_items ); ?>'>
                    <div data-repeater-item>
                        <div class='etn-form-group mb-2'>
                            ...
                            <input  type='text' name='icon' class='etn-social-icon etn-form-control'  data-toggle='modal' placeholder="<?php echo esc_html__('fab fa-facebook','eventin'); ?>" data-target='#etn-event-es-social-modal'/>
