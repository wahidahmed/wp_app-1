...
// if checkout time and order_status is processing/completed then ticket mail will sent
     ...
     * @return void
     */
    public static function get_events_by_date( $month, $year, $display, $endDate ) {
        ...
        foreach ( $all_event_ids as $single_event ) {
            ...
            $start_time = date("H:i:s", strtotime(get_post_meta( $event_id, 'etn_start_time', true )));
            $end_time   = date("H:i:s", strtotime(get_post_meta( $event_id, 'etn_end_time', true )));
