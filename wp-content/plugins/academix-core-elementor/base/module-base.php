<?php
namespace AcademixCoreElementor\Base;
...
abstract class Module_Base {
    ...
    public function __clone() {
        ...
        _doing_it_wrong( __FUNCTION__, __( 'Cheatin&#8217; huh?', 'academix-core-elementor' ), '1.0.0' );
    }
    ...
    public function init_widgets() {
        ...
        foreach ( $this->get_widgets() as $widget ) {
            ...
            $widget_filename = 'ace-' . str_replace( '_', '-', $widget_name );
